...
<nav class="navbar navbar-expand-lg bg-black">
    <div class="container-fluid">
        ...
        <a href="#" id="logo" style="font-size: 32px"><b></i>D&R</b></a>
                    ...
                    <div class="dropdown d-flex  ">
                        <nav class="btn btn-secondary me-2 "  data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            if (isset($_SESSION['email'])) {
                                ...
                                echo "<img class=\"profilePic\" src=\"http://localhost:8080/Restaurant2.0/pictures/{$profilePic}\" width=\"50\" height=\"50\" alt=\"profilkep\">";
