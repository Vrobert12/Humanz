                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                            <li><?php
                                if (isset($_SESSION['email']) && isset($_SESSION['name'])) { //A session segitsegevel megadjuk az adatok ertekeit
                                    ...
                                    while ($row = $stmt->fetch_assoc())
                                    if ($_SESSION['email'] == $row['adminMail']) {
                                        echo "<li><a class=\"dropdown-item\" href=\"admin.php\"><i class=\"bi bi-list-task\"></i> Asztalok</a></li>";
                                        echo "<li><a class=\"dropdown-item\" href=\"users.php\"><i class=\"bi bi-people\"></i> Felhasználók</a></li>";
                                        echo "<li><a class=\"dropdown-item\" href=\"workers.php\"><i class=\"bi bi-person-workspace\"></i> Dolgozók</a></li>";
