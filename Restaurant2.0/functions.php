    ...
    public function registration()
    {
        ...
        if (isset($_POST['knev']) && isset($_POST['vnev']) && isset($_POST['tel1']) && isset($_POST['tel2']) && isset($_POST['mail']) && isset($_POST['pass']) && isset($_POST['pass2'])) {
            ...
            try {
                ...
                $sql = "INSERT INTO regisztralo (keresztnev, vezeteknev, telefonszam, regisztraloEmail, regisztraloJelszo, verification_code,verify,profilkep) VALUES (?,?, ?, ?, ?,?, ?,?)";
                $stmt = $conn->prepare($sql);
                $verrification = 0; // Placeholder for verification_code
                $stmt->bind_param("ssissiis", $knev, $vnev, $tel, $mail, $pass, $verification_code, $verrification, $kep);
